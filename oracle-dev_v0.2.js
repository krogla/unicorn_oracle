...
console.log('UnicornGO Oracle by KRogLA');
    ...
    .on('data', function (event) {
        ...
        request({
            ...
            if (response.statusCode == 200) {
                ...
                const data = bb_contract.methods.oracleCallback(childId, body.chain).encodeABI();
...
br_contract.events.HybridizationAccept()
    .on('data', function (event) {
        ...
        publishUnicornEvent('hybridization', [
            //TODO get owners
...
function updateUnicornStatus(id, data) {
    request({
        method: 'PUT',
        uri:  process.env.URL_SATUS+id,
        json: data
    }, function (error, response, body) {

    })
    return fetch(baseUrl + `v1/unicorn/`+id, {
        method: 'PUT',
        headers: {
