...
MongoClient.connect("mongodb://localhost:27017", function(err, client) {
    ...
    let cursor =  holders.find({ count: { $gt: 1 }, contract: false, candy: 0}).sort({count: -1}).limit(200);
